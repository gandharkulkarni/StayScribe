...
/**
 * Servlet handles requests on /viewExpediaVisitHistory path
 * By: Gandhar Kulkarni
 */
public class ViewExpediaVisitServlet extends HttpServlet {

    /**
     * Handles GET request on /viewExpediaVisitHistory path
     *
     * @param request
     * @param response
